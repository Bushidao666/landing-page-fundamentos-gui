  ...
  return (
    <section className="relative py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-b from-white via-blue-50/10 to-white">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true" role="presentation">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] md:w-[800px] md:h-[800px] bg-gradient-to-r from-blue-200 via-purple-200 to-pink-200 rounded-full blur-2xl opacity-5" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-10 sm:space-y-12 md:space-y-16">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 leading-relaxed text-center mb-8">
