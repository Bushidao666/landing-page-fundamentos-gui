    ...
    >
      ...
      >
        ...
        <div className="absolute top-0 left-1/4 
                        w-[min(600px,50vw)] h-[min(600px,50vh)]
                        bg-gradient-radial from-[#D4AF37]/8 to-transparent 
        ...
        <div className="absolute bottom-0 right-1/4 
                        w-[min(500px,40vw)] h-[min(500px,40vh)]
                        bg-gradient-radial from-blue-600/6 to-transparent 
