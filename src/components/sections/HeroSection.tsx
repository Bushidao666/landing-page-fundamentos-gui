    ...
    >
        ...
        <div className="absolute inset-0">
          ...
          <div className="flex items-center justify-center min-h-[85vh]">
            ...
            <motion.div
              className="space-y-10 text-center max-w-5xl mx-auto"
              variants={containerVariants}
            >
            {/* Badge Premium - Google Ads Master */}
            <motion.div
              className="inline-flex items-center gap-3 bg-gradient-to-r from-[#D4AF37]/20 via-[#D4AF37]/10 to-[#D4AF37]/20 backdrop-blur-xl border border-[#D4AF37]/40 px-6 py-3 rounded-full shadow-2xl"
              variants={itemVariants}
            >
              <Target className="w-4 h-4 text-[#D4AF37]" />
              <span className="text-[#D4AF37] font-semibold text-sm uppercase tracking-[0.15em]">
            ...
            <motion.div className="space-y-4" variants={itemVariants}>
              <motion.h1
                className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-serif font-black leading-[0.9] tracking-tight text-white"
                variants={itemVariants}
              >
                ...
                <span className="block text-gray-200 text-3xl md:text-4xl lg:text-5xl font-light mt-2">
                  Chamado Google Ads?
                </span>
              </motion.h1>
              ...
              <motion.div 
                className="flex items-center justify-center gap-3 text-[#D4AF37] text-lg font-semibold max-w-4xl mx-auto"
                variants={itemVariants}
              >
            ...
            <motion.div className="space-y-6" variants={itemVariants}>
              ...
              <div className="flex items-center justify-center gap-8 flex-wrap max-w-4xl mx-auto">
                <div className="flex items-center gap-2 text-gray-400">
                  ...
                  <span className="text-sm font-medium">Sem Desperdício</span>
                </div>
                <div className="flex items-center gap-2 text-gray-400">
                  <Target className="w-4 h-4 text-[#D4AF37]" />
                ...
                <div className="flex items-center gap-2 text-gray-400">
                  <TrendingUp className="w-4 h-4 text-[#D4AF37]" />
                  <span className="text-sm font-medium">Escala Inteligente</span>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              className="flex flex-wrap items-center justify-center gap-4 lg:gap-6 pt-10 text-sm text-gray-300 max-w-4xl mx-auto"
              variants={floatingVariants}
            >
              <motion.div 
                className="flex items-center gap-3 bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-xl px-5 py-4 rounded-xl border border-white/20 shadow-lg"
                whileHover={{ scale: 1.05, y: -2 }}
              >
      ...
      >
        <motion.div 
          className="w-8 h-12 border-2 border-[#D4AF37]/60 rounded-full flex justify-center backdrop-blur-sm bg-white/5"
          animate={{ y: [0, -12, 0] }}
          transition={{ duration: 2.5, repeat: Infinity }}
        >
          <motion.div 
            className="w-1.5 h-4 bg-gradient-to-b from-[#D4AF37] to-transparent rounded-full mt-3"
            animate={{ 
              opacity: [1, 0.3, 1],
